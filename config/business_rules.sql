...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-baunit-has-parcels', 'application-baunit-has-parcels', 'sql', 'Title must have Parcels::::Недвижимость должна иметь участок::::سند الملكية يجب ان يحتوي على قطع::::Un titre doit contenir au moins un numéro de parcelle::::::::::::Título deve ter Parcelas::::::::财产必须有几块宗地。', NULL, '#{id}(application.service.id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('document-supporting-rrr-is-current', 'document-supporting-rrr-is-current', 'sql', 'Documents supporting rights (or restrictions) must have current status::::Документы использующиеся для регистрации прав или ограничений должны иметь текущий (активный) статус.::::الوثائق التي تدعم الحقوق او القيود يجب ان يكون لها الحالة الحالية::::Les documents justificatifs de droits (ou restrictions) doivent avoir le statut courant.::::::::::::Documentos comprovativos direitos (ou restrições) devem ter o status atual::::::::支持（或限制）权利的文件必须为目前状态。', NULL, '#{id}(application.service.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('new-cadastre-objects-present', 'new-cadastre-objects-present', 'sql', 'New cadastral objects must be defined::::Новые кадастровые объекты должны быть определены.::::يجب تحديد كائن مساحة جديد::::Les nouveaux objets cadastres doivent être définis.::::::::::::Novos objetos cadastrais devem ser definidos::::::::新的地籍目标必须明确。', NULL, '#{id}(transaction_id) is requested');
...
result::::::::السجلات تحت الدمج لا يجب ان تظهر في نتائج الوجهة ::::::::::::::::Registros sendo consolidados não devem estar presente no destino.
resultado::::::::合并的记录不必出现在最终目标中。', '', '');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('service-on-complete-without-transaction', 'service-on-complete-without-transaction', 'sql', 'Service ''req_type'' must have been started and some changes made in the system::::Услуга ''req_type''  должна быть запущена и сделаны какие-либо изменения.::::يجب ان تكون  اخدمة ''req_type'' قد بدأت وهناك تغييرات غلى النظام::::Le service ''req_type'' doit avoir commencé et des changements faits dans le système.::::::::::::Serviço ''req_type'' deve ter sido iniciado e algumas mudanças feitas no sistema::::::::服务 “请求_类型”必须启动并在系统中作些改变。', NULL, '');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('power-of-attorney-service-has-document', 'power-of-attorney-service-has-document', 'sql', 'Service ''req_type'' must have must have one associated Power of Attorney document::::Услуга ''req_type''  должна иметь одну доверенность.::::خدمة ''req_type'' يجب ان ترتبط بوكالة::::Le service ''req_type'' doit avoir un document de procuration associé.::::::::::::Serviço ''req_type'' deve ter uma Procuração associada::::::::服务 “请求_类型”必须具备一份相关的委托书文件。', NULL, '#{id}(application.service.id)');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('target-parcels-present', 'target-parcels-present', 'sql', 'Target parcel(s) must be selected::::Целевые участки должны быть выбраны.::::يجب اختيار القطعة المستهدفة::::Le(s) parcelle(s) doivent être sélectionnées.::::::::::::Parcela alvo(s) deve ser selecionada::::::::必须选定目标宗地。', NULL, '#{id}(transaction_id) is requested');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('rrr-must-have-parties', 'rrr-must-have-parties', 'sql', 'These rights (and restrictions) must have a recorded party (or parties)::::Данные права (или ограничения) должны иметь правообладателей.::::هذه الحقوق او القيود يجب ان يكون عليها اطراف معرفون::::Ces droits (et restrictions) doivent avoir une partie ou des parties enregistrées::::::::::::Estes direitos (e restrições) devem ter uma parte registrado (ou partes)::::::::这些权利(和限制) 必须有一个或多个记录对象。', NULL, '');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-spatial-unit-not-transferred', 'application-spatial-unit-not-transferred', 'sql', 'An application must not use a parcel already transferred.::::::::لا يمكن للطلب استخدام قطعة تم نقلها سابقا::::::::::::::::Um pedido não deve usar uma parcela já transferida.::::::::一项申请不适用于已转让的宗地。', NULL, 'It checks if the application has no spatial_unit that is already targeted by an application that has the status  transferred.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('bulk-spatial-name-unique', 'bulk-spatial-name-unique', 'sql', 'Cadastre objects with must have unique names.::::Кадастровые объекты должны иметь уникальные коды.::::كينونات المساحة يجب ان يكون لها اسماء غير مكررة::::::::::::::::Cadastro de objetos deve ter nome único.::::::::地籍目标必须有独特的名称。', NULL, '#{id}(transaction_id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('bulk-spatial-geom-overlaps-with-loading-geom', 'bulk-spatial-geom-overlaps-with-loading-geom', 'sql', 'New cadastre objects must not overlap with other new cadastre objects. ::::Новые кадастровые объекты не должны пересекаться с другими новыми объектами.::::الكينونات المساحية الجديدة لا يجب ان تتداخل مع كينونات مساحة  جديدة أخرى::::::::::::::::Novo cadastro de objetos não deve se sobrepor com novo cadastro de objetos existentes.::::::::新的地籍目标不能与其他新的地籍目标相交叠。 ', NULL, '#{id}(transaction_id) is requested');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('consolidation-extraction-file-name', 'Consolidation extraction file name', 'sql', '111.0::::::::::::::::::::::::::::::::111.0', 'Generates the name of the extraction file for the consolidation. The extension is not part of this generation.', '');
...
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('rrr-has-pending', 'rrr-has-pending', 'sql', 'There are no other pending actions on the rights and restrictions being changed or removed on this application::::Нет никаких изменений в правах и ограничениях, сделанных из текущего заявления::::لا يوجد حركات بحاجة لتنفيذ على الحقوق او القيود لهذا الطلب::::Il n''y a pas d''autre actions en attente sur les droits et restrictions en cours de changement ou supprimé de cette application.::::::::::::Não há outras ações pendentes sobre os direitos e restrições sendo alterados ou removidos neste pedido::::::::在申请中没有其他有关产权和限制的待定操作被改变或消除。', NULL, '#{id}(administrative.rrr.id) is requested. It checks if for the target rrr there is already a pending edit or record.');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('service-has-person-verification', 'service-has-person-verification', 'sql', 'Within the application for the service a personal identification verification should be attached.::::В заявлении должен присутствовать документ удостоверяющий личность.::::ضمن الطلب ولاجل الخدمة يجب  ارفاق وثيقة تعريف بالشخصية::::Pour la demande d''un service, la vérification de l''identification personnelle doit être attachée.::::::::::::Dentro do pedido para o serviço deve ser anexado uma verificação de identificação pessoal.::::::::申请内要附上个人身份证明。', NULL, '#{id}(application.service.id) is requested');
INSERT INTO br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('application-br6-check-new-title-service-is-needed', 'application-br6-check-new-title-service-is-needed', 'sql', 'An application can be associated with a property which should have a digital title record.::::Заявление должно содержать недвижимость которая имеет электронную запись в базе.::::الطلب يجب ارتباطه بملكية لها سند ملكية الكتروني::::Une demande peut être associée à une propriété qui doit avoir une trace de titre numérique.::::::::::::Um pedido pode ser associado a uma propriedade que deve ter um registro digital do título.::::::::申请可以和有数字产权记录的财产一起进行。', NULL, 'Rule checks to see if there is a ba_unit record for the property identified for the application at lodgement');
...
select 0=0 as vl
');
INSERT INTO br_definition (br_id, active_from, active_until, body) VALUES ('cancel-relation-notification', '2015-10-12', 'infinity', 'UPDATE application.notify_property
 set status = ''x''
...
select 0=0 as vl
');
INSERT INTO br_definition (br_id, active_from, active_until, body) VALUES ('delete-relation-notification', '2015-10-12', 'infinity', 'DELETE from application.notify
WHERE 
service_id in (
